...
var Product = /** @class */ (function () {
    function Product() {
        ...
        this.producttype.post("/post", productschema_1.productSchema.createproduct(), productschema_1.productSchema.handlesError, function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var docs, err_1;
        ...
        this.producttype.put("/update/:id", productschema_1.productSchema.updatedata(), productschema_1.productSchema.handlesError, function (req, res, next) { return __awaiter(_this, void 0, void 0, function () {
            var dat, docs, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
